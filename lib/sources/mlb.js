...
async function backfillSeason(year) {
    ...
    for (const date of dates) {
        for (const game of date.games || []) {
            ...
            const homeTeamId = db.upsertTeam('mlb', homeTeamMeta.id, homeTeamMeta.name, homeTeamMeta.name);
            const awayTeamId = db.upsertTeam('mlb', awayTeamMeta.id, awayTeamMeta.name, awayTeamMeta.name);
